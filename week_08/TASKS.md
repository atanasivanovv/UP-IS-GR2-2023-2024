...
Упражнете всички побитови операции и какво правят те!

**Задача 0.1** Напишете задача, която чрез побитови операции определя дали е четно или нечетно. 
...
**Задача 6:** Дадени са числата a, b, и две позиции i и j. Заменете битовете на позиции i до j в числото a с битовете на числото b.
Пример:
Вход: a = 1024 (10000000000 в двоична бройна система), b = 19 (10011 в двоична бройна система), i = 2, j = 6
Изход: 1100 (10001001100 в двоична бройна система)